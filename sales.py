...
class salesClass:
    def __init__(self,root):
        ...
        #==================Images==================
        self.bill_photo=Image.open("images/port-4.jpg")
        self.bill_photo=self.bill_photo.resize((390,280),Image.ANTIALIAS)
        self.bill_photo=ImageTk.PhotoImage(self.bill_photo)  

        lbl_image=Label(self.root,image=self.bill_photo,bd=0).place(x=700,y=150)
