...
class employeeClass:
    def __init__(self,root):
        ...
        #===========Title========================
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#0f4d7d",fg="#fff").place(x=50,y=100,width=1000)

        #===========Content========================
        #=============Row1==================
        lbl_empid=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="#fff").place(x=50,y=150)
        lbl_gender=Label(self.root,text="Gender",font=("goudy old style",15),bg="#fff").place(x=390,y=150)
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="#fff").place(x=750,y=150)
        ...
        #txt_gender=Entry(self.root,textvariable=self.var_gender,font=("goudy old style",15),bg="#fff").place(x=500,y=150,width=180)
        ...
        #=============Row2==================
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="#fff").place(x=50,y=190)
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15),bg="#fff").place(x=400,y=190)
        lbl_doj=Label(self.root,text="D.O.J",font=("goudy old style",15),bg="#fff").place(x=750,y=190)
        ...
        #=============Row3==================
        lbl_email=Label(self.root,text="Email",font=("goudy old style",15),bg="#fff").place(x=50,y=230)
        lbl_pass=Label(self.root,text="Password",font=("goudy old style",15),bg="#fff").place(x=400,y=230)
        lbl_utype=Label(self.root,text="User Type",font=("goudy old style",15),bg="#fff").place(x=750,y=230)
        ...
        txt_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee"),state='readonly',justify=CENTER,font=("goudy old style",15))
        txt_utype.place(x=850,y=230,width=180)
        txt_utype.current(0)

        #=============Row4==================
        lbl_address=Label(self.root,text="Address",font=("goudy old style",15),bg="#fff").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="#fff").place(x=500,y=270)
        ...
        #===============Button==================
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="#fff",cursor="hand2").place(x=500,y=305,width=110,height=28)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",fg="#fff",cursor="hand2").place(x=620,y=305,width=110,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="#fff",cursor="hand2").place(x=740,y=305,width=110,height=28)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607b8d",fg="#fff",cursor="hand2").place(x=860,y=305,width=110,height=28)
